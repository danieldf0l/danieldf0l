...
## Sobre mim
Atuo Como suporte técnico N1 em serviços de Cloud e hospedagens Dedicadas na Locaweb. Mas, já atuei como estagiário em análise de dados desenvolendo aplicações de automação de ETL para geração de Dashboards em PowerBI.
...
## Interesses
Já estudei C#, Java, HTML&CSS e JS, mas hoje foco em Python voltado para análise de dados e automação com o Pandas, Numpy, Requests.
</div>
